...
CREATE TABLE "devis" (
    ...
    "notes" TEXT,
    "conditions" TEXT,
    "montant_ht" DECIMAL(65,30) NOT NULL DEFAULT 0,
    "tva_taux" DECIMAL(65,30) NOT NULL DEFAULT 20,
    "tva_montant" DECIMAL(65,30) NOT NULL DEFAULT 0,
    "montant_ttc" DECIMAL(65,30) NOT NULL DEFAULT 0,
    "acompte_requis" BOOLEAN NOT NULL DEFAULT true,
    "acompte_pourcentage" DECIMAL(65,30) NOT NULL DEFAULT 30,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "factures" (
    ...
    "tva_montant" DECIMAL(65,30) NOT NULL DEFAULT 0,
    "montant_ttc" DECIMAL(65,30) NOT NULL DEFAULT 0,
    "montant_paye" DECIMAL(65,30) NOT NULL DEFAULT 0,
    "acompte_deduit" DECIMAL(65,30),
...
CREATE TABLE "parametres" (
    ...
    "telephone" TEXT,
    "site_web" TEXT,
    "tjm_defaut" DECIMAL(65,30),
    "tva_taux_defaut" DECIMAL(65,30) NOT NULL DEFAULT 20,
    "delai_validite_devis" INTEGER NOT NULL DEFAULT 30,
    "delai_paiement" INTEGER NOT NULL DEFAULT 30,
    "acompte_pourcentage_defaut" DECIMAL(65,30) NOT NULL DEFAULT 30,
